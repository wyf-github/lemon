...
test_data=DoExcel(project_path.testcases_path,'recharge').read_data('RechargeCASE')#获取测试数据
#测试充值
my_log=MyLog()
...
class TestCases(unittest.TestCase):
    ...
    def setUp(self):#测试之前的准备工作
        print("1")
        self.t=DoExcel(project_path.testcases_path,'recharge')#写入测试结果的对象
        print("2")
    def tearDown(self):
        pass
    ...
    def test_cases(self,case):
        ...
        try:
            ...
            self.t.write_data(case['CaseId']+1, 8, resp.text)
